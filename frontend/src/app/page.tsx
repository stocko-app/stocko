  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative max-w-4xl mx-auto px-4 text-center">
        <motion.div {...fadeUp(0)}>
          <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-gold-400 border border-gold-400/30 rounded-full px-4 py-1.5 mb-6">
...
function Features() {
  return (
    <section className="py-24 px-4 bg-navy-900/40">
      <div className="max-w-6xl mx-auto">
        <motion.div {...fadeUp()} className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-4">
            Tudo o que precisas
          ...
          {tiers.map((tier, i) => (
            <motion.div key={tier.name} {...fadeUp(i * 0.07)}>
              <div className="glass glass-hover rounded-2xl p-5 text-center h-full flex flex-col items-center gap-3">
                <div
                  className={`w-14 h-14 rounded-full bg-gradient-to-br ${tier.color} flex items-center justify-center text-2xl shadow-lg`}
                >
                  {tier.icon}
                </div>
                <div>
...
function Rankings() {
  return (
    <section id="rankings" className="py-24 px-4 bg-navy-900/40">
